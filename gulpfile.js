...
gulp.task('build-catalog', function(done) {
    var spawnSync = require('child_process').spawnSync;
...
gulp.task('watch-catalog', gulp.series('build-catalog'), function() {
    return gulp.watch('datasources/**/*', watchOptions, ['build-catalog']);
});

gulp.task('render-markdown-pages', function(done) {
    var spawnSync = require('child_process').spawnSync;
...
gulp.task('watch-markdown-pages', gulp.series('render-markdown-pages'), function() {
    return gulp.watch('pages/**/*', watchOptions, gulp.series('render-markdown-pages'));
});
...
gulp.task('publish-catalog', function(done) {
...
gulp.task('update-init-url', function(done) {
    const date = releaseLabel();
...
gulp.task('push-config-and-catalog', function(done) {
...
gulp.task('release-catalog', gulp.series('build-catalog', 'publish-catalog', 'update-init-url', 'push-config-and-catalog'));
...
gulp.task('build', gulp.series('build-catalog', 'render-markdown-pages', 'copy-terriajs-assets', 'build-app'));
gulp.task('release', gulp.series('build-catalog', 'render-markdown-pages', 'copy-terriajs-assets', 'release-app', 'make-editor-schema'));
gulp.task('watch', gulp.parallel('watch-catalog', 'watch-markdown-pages', 'watch-terriajs-assets', 'watch-app'));
