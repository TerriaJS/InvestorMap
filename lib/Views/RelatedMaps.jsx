  ...
  return (
    ...
    >
      ...
      <div className={classNames(PanelStyles.section, Styles.section)}>
        <a target="_blank" href="http://nationalmap.gov.au/">
          <img
            ...
            src={require("../../wwwroot/images/nationalmap.jpg")}
        ...
        <p>
          ...
          Australian government agencies. It is an initiative of the Australian
          Government's Department of the Prime Minister and Cabinet and the
          software has been developed by Data61 working closely with the
          Department of the Prime Minister and Cabinet, Geoscience Australia and
      ...
      <div className={classNames(PanelStyles.section, Styles.section)}>
        ...
        <p>
          The DroughtMap is a platform built for the Australian joint Agency
          Drought Taskforce to assist with planning and management of drought
